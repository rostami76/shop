                                    ...
                                    <div>
                                        <ul>
                                            @foreach($category->children as $childCategory)
                                                <li><a href="category.html">{{$childCategory->title}} @if($childCategory->children->count())<span>&rsaquo;</span>@endif</a>
                                                    @if($childCategory->children->count())
                                                        <div class="dropdown-menu">
                                                            <ul>
                                                                @foreach($childCategory->children as $subChildCategory)
                                                                    <li><a href="category.html">{{$subChildCategory->title}}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
                                                    @endif
